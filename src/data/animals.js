...
const BASE_ANIMALS = [
  ...
  // additional single-word animals containing 'a'
  'anaconda','aracari','anole','aardwolf','antbird','arapaima','ararauna',
  'caiman','cacomistle','cavy','cardinal','cockatiel','clownfish','crayfish','coral',
