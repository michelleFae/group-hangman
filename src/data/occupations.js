...
const BASE = [
  ...
  ,'nutritionist','dietitian','pharmacist','pharmasist','gynecologist','gynacologist','andrologist','urologist','obstetrician','olympian','sportsphysician','sportsdoctor'
  // STEM professions
  ,'datascientist','dataengineer','mlengineer','engineer','computerscientist','neuroscientist', 'neurologist','bioinformatician','roboticist','astrophysicist','quant','cryptographer','bioengineer','labtechnician','geneticist'
  ...
  ,'hacker','milker','cuddler','taster','sleeper','acupuncturist','psycologist','pentester'
